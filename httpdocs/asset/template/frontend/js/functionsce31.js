...
(function($) {
        ...
        lazyLoad: function() {
            ...
            if (lazyLoadEl.length > 0) {
                lazyLoadEl.each(function() {
                    ...
                    element.attr('src', 'images/blank.svg').css({ 'background': 'url(asset/template/frontend/images/preloader.gif) no-repeat center center #FFF' });
    ...
    SEMICOLON.header = {
        ...
        menufunctions: function() {
            ...
            if (SEMICOLON.isMobile.Windows()) {
                ...
                $('#primary-menu ul li:has(ul)').append('<a href="#" class="wn-submenu-trigger"><i class="fas fa-chevron-down"></i></a>');
        ...
        topsearch: function() {
            ...
            $(document).on('click', function(event) {
                if (!$(event.target).closest('.top-search-form').length) { $body.toggleClass('top-search-open', false); }
    ...
    SEMICOLON.widget = {
        ...
        navTree: function() {
            ...
            if ($navTreeEl.length > 0) {
                $navTreeEl.each(function() {
                    ...
                    element.find('ul li:has(ul) > a').append(' <i class="fas fa-chevron-down"></i>');
        ...
        notifications: function(element) {
            ...
            if ($(element).hasClass("item-quick-view")) {
                $(element).find("i").removeClass("icon-line-heart").addClass("fas fa-heart text-danger");
                $(element).removeAttr("href");
                $(element).removeAttr("onclick");
                /*$(element).off("click").attr('href', "javascript: void(0);"); */
                /*return false;*/
            }
        ...
        cartQuantity: function() {
            ...
            /*$(document).on("click", ".plusHomePage", function() {
                var productQuantity = $(this).parents('.quantity').find('.qty').val(),
                    intRegex = /^\d+$/;
            ...
            $(document).on("click", ".minusHomePage", function() {
                var productQuantity = $(this).parents('.quantity').find('.qty').val(),
                    intRegex = /^\d+$/;
